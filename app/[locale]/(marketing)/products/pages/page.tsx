...
import { ChartAreaIcon, Palette, Share2 } from "lucide-react";
...
export default async function Home({
  ...
  const t = await getTranslations("products.pages");
  ...
  return (
    <ProductPage
      ...
      features={[
        {
          title: t("features.full-customization.title"),
          description: t("features.full-customization.description"),
          icon: <Palette className="h-5 w-5" />,
        },
        {
          title: t("features.social-integration.title"),
          description: t("features.social-integration.description"),
