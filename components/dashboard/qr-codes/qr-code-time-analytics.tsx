...
export const QRCodeTimeAnalytics = ({
  ...
  const t = useTranslations("qr-code-time-analytics");
  ...
  function getDateRange(optionKey: string, createdAt: Date): DateRange {
    ...
    return (
      <div className="lg:p-6 sm:p-4 p-3 rounded bg-background shadow w-full flex flex-col gap-4 justify-between">
        <div className="w-full flex flex-col gap-1 items-start">
          <CardTitle>{t("scans-over-time")}</CardTitle>
          <CardDescription>
            {t("showing-scans")} {formatHumanDateRange(dateRange, createdAt)}.
          </CardDescription>
