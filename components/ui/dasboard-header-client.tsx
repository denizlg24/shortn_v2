      ...
      {user && (
        <Popover>
          <PopoverTrigger asChild className="group">
            <Button variant={"outline"} className="py-1! h-full px-2! max-w-36">
          ...
          <PopoverContent className="w-[300px] p-0 z-99">
            ...
            <div className="w-full p-4 flex flex-row gap-2 items-start justify-between">
              <div className="flex flex-col gap-0 items-start">
                ...
                {user.plan.subscription == "plus" && (
                  <p className="text-xs text-muted-foreground">Plus Account</p>
                )}
            ...
            <div className="w-full py-2 flex flex-col gap-0">
              <Button
                ...
                variant="ghost"
              >
                <Link href={`/dashboard/${user.sub.split("|")[1]}/profile`}>
                  <Settings />
                  Profile Settings
                </Link>
              </Button>
